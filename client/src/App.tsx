...
import AdminSalesReports from "./components/AdminSalesReports";
...
import "./App.css";
import RequireAffiliate from "./components/RequireAffiliate";
    ...
    <>
      ...
      <Routes>
        ...
        >
          ...
          <Route path="sales report" element={<AdminSalesReports />} />
